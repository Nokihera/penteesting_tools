...
# 1. Image Sorting
mv $dl_path/*.jpg $dl_path/*.png /home/touchme/Pictures 2>/dev/null
echo -ne "${GREEN}######                    (33%)${NC}\r"
sleep 0.1

# 2. Document & Video Sorting
mv $dl_path/*.pdf $dl_path/*.txt /home/touchme/Documents 2>/dev/null
mv $dl_path/*.mp4 /home/touchme/Videos 2>/dev/null
echo -ne "${GREEN}############              (66%)${NC}\r"
sleep 0.1

# 3. Music Sorting
mv $dl_path/*.mp3 $dl_path/*.flac /home/touchme/Music 2>/dev/null
